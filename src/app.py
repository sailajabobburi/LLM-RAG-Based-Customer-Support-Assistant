...
def display_response(query, df, index):
    ...
    distances, indices = semantic_similarity(query, index, model=EMBEDDING_MODEL)
    ...
    llm_response = generate_response(query, top_similar_instructions['response'].tolist())
...
if 'llm_response' in st.session_state:
    ...
    if st.button("Regenerate Response"):
        if feedback:
            ...
            new_llm_response = generate_response(new_query, top_similar_instructions['response'].tolist())
